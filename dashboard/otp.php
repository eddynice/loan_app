...
<head><meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <meta charset="utf-8">
  <title> Account Verify | <?php echo $site_title; ?> </title>
...
<strong></strong>
            ...
            <div class="form-inputs p-b">
               ...
               <input type="text" name="otp" id="code" class="form-control" sttle="width:140px" placeholder="Enter Your OTP Code" required>
         <br/>
    ...
    <div class="btn-group">
        ...
        <button type="submit" style="background-color: #114f95;"  name="login"   class="btn btn-primary py-3" onclick="">Verify Signin</button>
            ...
            </p> <p class="text-center">Please, insert the code<br> sent to your email</p>
          </form>
                </div>
