...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Calculate the amount to save for each interval
    switch ($interval) {
        case 'daily':
            $savingAmount = $targetAmount / $timeFrame;
            break;
        case 'weekly':
            $savingAmount = $targetAmount / ($timeFrame / 7);
            break;
        case 'monthly':
            $savingAmount = $targetAmount / ($timeFrame / 30); // Approximating 30 days per month
            break;
        default:
            $savingAmount = 0;
            break;
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="resultModalLabel">Savings Calculation Result</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <?php if (isset($savingAmount)) { ?>
                        <p>To reach your target amount of <?php echo $targetAmount; ?> within <?php echo $timeFrame; ?> <?php echo $interval; ?>s:</p>
                        <p>You need to save approximately #<?php echo number_format($savingAmount, 1); ?> per <?php echo $interval; ?>.</p>
                    <?php } else { ?>
                ...
                <a href="subscription.php" class="btn btn-primary">Subscription</a>
                    <a href="summary.php" class="btn btn-secondary">Go Back</a>
                </div>
            </div>
        </div>
    </div>
