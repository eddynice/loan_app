			  ...
			  <div class="col-lg-6">
                      <div class="form-group">
						...
						<select  name="billing_code" class="form-control input-sm validate[required]">
							<option value="1">ACTIVATE WITH BILLING CODE</option>
							<option value="5">ACTIVATE LIVE TRANSFER</option>
							<option value="0">DEACTIVATE BILING (ONLY OTP)</option> 
							<option value="2">START-FROM-COT-PAGE</option>
								<option value="3">START FROM-TAX-PAGE</option>
									<option value="4">START-FORM-IMF-PAGE</option>
						</select>
				 
                </div></div>
                <br/>
					<button type="submit" name="set" class="btn btn-info ">Set/Dialy Billing Code</button>
				</form>
