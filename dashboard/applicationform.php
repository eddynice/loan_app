...
$passport = $_FILES['passport']['name']; // Get the name of the uploaded file
$filepath = "uploads/"; // Specify the directory where you want to save the uploaded file

// Construct the full file path by concatenating directory, temporary file path, and file name
$fullFilePath = $filepath . $_FILES['passport']['name'];

// Move the uploaded file to the desired directory using move_uploaded_file() function
// if (move_uploaded_file($_FILES['passport']['tmp_name'], $fullFilePath)) {
//     echo "File uploaded successfully!";
// } else {
//     echo "File upload failed.";
// }

move_uploaded_file($_FILES['passport']['tmp_name'], $fullFilePath);
    ...
    if ($stmt->rowCount() > 0 || $stmt1->rowCount() > 0) {
        ...
        if ($reg_user->createsign($fname, $mname, $lname, $uname, $upass, $phone, $email, $type, $reg_date, $work, $acc_no, $addr, $passport, $sex, $dob, $marry, $t_bal, $a_bal, $currency, $cot, $tax, $imf, $pin_auth, $pin, $verify, $status)) {
            $id = $reg_user->lasdID();
     ...
     <P style='font-size:15px;font-weight:normal;color:#0076b6;'>Congratulations,Your Application  have been recieved and<br> is being checked, you will recieve a reply from our Accounts Department shortly </P>
                              ...
                              <tr>
                                <td valign='top' align='center'>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                      <p style=' font-weight:bold;font-size:13px;line-height: 30px;'>Payhub, Member FDIC</p>
                                    </div>
                                  </div>
           ...
           <form role="form" style="width:98%; padding-left:15px; "  method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="text" name="phone" class="input-sm validate[required] form-control" placeholder="Eg 15874884398" required>
                        </div>
                        <div class="col-md-3 form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 form-group" id="date-time">
                            ...
                            <div class="input-icon datetime-pick date-only">
                                <input data-format="dd/MM/yyyy" name="dob" type="date" placeholder="Select Date of Birth" class="form-control input-sm" required />
                                <span class="add-on">
                                    <i class="sa-plus"></i>
                                </span>
                            </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="file" name="passport" class="input-sm validate[required] form-control" placeholder="Passport" required>
                        </div>
                        <!-- <div class="col-md-3 form-group">
...
<div class="col-md-3 form-group">
                            ...
                            <select class="input-sm validate[required] form-control" name="currency" required>
                               <option value="USD">Nigeria – NGN</option>
<option value="AFN">America Dollar – USD</option>
                         ...
                         <div class="col-md-2 form-group">
                          <input type="hidden" data-format="dd/MM/yyyy" value="<?php echo " " . date("d/m/Y") ; ?>" name="reg_date" > 
                            ...
                            <?php $accno1 = rand(1,9) . substr (time() , 4, 6) . rand(100,999); ?>
                            
                             <input type="text" name="acc_no"  placeholder="" value="<?php echo $accno1; ?>" hidden  >
                             <?php 
...
?>
                            <input type="text" name="cot" class="input100" value="<?php echo randomstring(6); ?>" hidden>
                            
                            <input type="text" name="tax" class="input100" value="<?php echo randomstring(6); ?>" hidden>
                            
                            <input type="text" name="<?php echo randomstring(6); ?>" class="input100" value="003" hidden>
                            <input type="text" name="pin_auth" class="input100" value="0024" hidden>
                            <input type="text" name="pin" class="input100" value="0035" hidden>
