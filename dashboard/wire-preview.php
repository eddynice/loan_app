                            ...
                            <table width='100%' border='0' cellspacing='0' cellpadding='0' align='center' valign='top'>
                              ...
                              <tr>
                                <td valign='top' align='center'>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                      <p style=' font-weight:bold;font-size:13px;line-height: 30px;'>NFCU Online</p>
                                    </div>
               ...
               <form autocomplete="off" method="post" action="" method="POST"  enctype="multipart/form-data" >
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Enter Amount (<?php echo $row['currency']; ?>)</label>
                        <input id="input-username" class="form-control form-control-alternative"  placeholder="Enter Amount Eg 23678" name="amount" type="number" value="<?php echo $_SESSION['amount']; ?>"  required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Enter Account Name</label>
                        <input id="input-email" value="" class="form-control form-control-alternative" placeholder="Enter Account Name" name="acc_name" type="text" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Enter IFSC Code</label>
                        <input id="input-last-name" value=""  class="form-control form-control-alternative" placeholder="Enter IFSC code" name="swift" type="text"  required>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Sender Bank Name</label>
                        <input id="input-last-name" class="form-control form-control-alternative" value="RB-PORTAL"   name="bank_name" type="text" readonly>
                   ...
                   <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" value="DISBURSMENT"  name="remarks" type="text" readonly required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Select Account Type</label>
                         <input class="form-control" value="MONEY TRANSFER"  name="acctype"  readonly type="text"  required>
                      </div>
                    </div>
                  </div>
