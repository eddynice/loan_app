...
// require_once '../include/admin.user.php';
...
if (isset($_POST['post'])) {
  ...
  $type_of_account = strip_tags($type_of_account);
  $type_of_account = htmlspecialchars($type_of_account);

  // $purpose = trim($_POST['purpose']);
  // $purpose = strip_tags($purpose);
  // $purpose = htmlspecialchars($purpose);

  // $interval_value = trim($_POST['interval']);
  // $interval_value = strip_tags($interval_value);
  // $interval_value = htmlspecialchars($interval_value);
 ...
 // Query to check if user is already subscribed
 //$stmt = $reg_user->runQuery("SELECT * FROM sub WHERE email = :email");
 //$stmt->execute();
...

{
  ...
  public function deposit($a_bal, ) {
    if ($a_bal > 0) {
        $currentBalance = $this->getBalance();
        $newBalance = $currentBalance + $a_bal;
...
if ($stmt->execute()) {
    // ...
    return "Deposited $" . number_format($a_bal, 2) . ". New balance: $" . number_format($newBalance, 2);
} else {
    // ...
  ...
  if ($_SERVER["REQUEST_METHOD"] === "POST") {
      ...
      $deposita_bal = $_POST["balance"];
      $depositResult = $account->deposit($deposita_bal);
  }
         ...
         <hr>
                 ...
                 <?php if (isset($depositResult)) { echo $depositResult; } ?>
                         ...
                         <div class="pl-lg-4">
                           <div class="row">
                             <div class="col-lg-6">
                               <div class="form-group">
                                 ...
                                 <label class="form-control-label" for="input-username"> (Customer subscripption)</label>
                                  <input id="input-username" class="form-control form-control-alternative"  placeholder="Customer Care" name="a_bal" type="text" disabled>
                               </div>
                             </div>
                           ...
                           <div class="row">
                             <div class="col-lg-6">
                               <div class="form-group">
                                 ...
                                 <label class="form-control-label" for="input-username">a_bal</label>
                                  <input id="input-username" class="form-control form-control-alternative"  placeholder="a_bal" name="a_bal" type="number" required>
                               </div>
                             </div>
                             ...
                             <label class="form-control-label" for="input-email">Type of Account</label>
                                     <select  name="type_of_account" class="form-control input-sm validate[required]" required>
                           ...
                           <div class="row">
                           <div class="col-md-6 form-group">
                             <label class="form-control-label" for="input-email">purpose </label>
                             <input id="input-username" class="form-control form-control-alternative"  placeholder="What are you saving for?" name="purpose" type="text">
                             ...
                             <div class="col-md-6 form-group">
                             <label class="form-control-label" for="input-email">Payment interval</label>
                                     <select  name="interval" class="form-control input-sm validate[required]" required>
                           ...
                           <div class="row">
                           <div class="col-md-6 form-group">
                                 <label class="form-control-label" for="input-first-name">Make sure is the email use in reg</label>
                                 <input id="input-username" class="form-control form-control-alternative"  placeholder="Email" name="email" type="email" required>
                                
                               </div>
                                <div class="col-md-6 form-group">
                                 <label class="form-control-label" for="input-first-name">Comments</label>
                                 <textarea class="form-control" name="comment" placeholder="Description " type="text" required></textarea>
                               </div>
                           </div>
                               <!-- <button type="submit">Subscribe</button> -->
                               <input class="btn btn-success" type="submit" name="post" value="Subscribe">
                         </div>
