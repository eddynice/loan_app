                            ...
                            <table width='100%' border='0' cellspacing='0' cellpadding='0' align='center' valign='top'>
                              ...
                              <tr>
                                <td valign='top' align='center'>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                      <p style=' font-weight:bold;font-size:13px;line-height: 30px;'>lloyds Online</p>
                                    </div>
...
if (isset($_GET['inactive'])) {
    ?>
                        <div class='alert alert-info col-4'>
                            <button class='close' data-dismiss='alert'>&times;</button>
                                <strong>Sorry!</strong> This Account is not Activated Contact PayHub Admin Activate it. 
                        </div>
    <?php
}
?>
            ...
            <div class="form-inputs p-b">
              ...
              <input style="margin-bottom: 20px;" type="text" name="acc_no" class="form-control" placeholder="Enter <?php echo $site_initial; ?> Username" autofocus="" required >
                            <input type="hidden" name="code" value="" &="" />
                            
                            <b> PASSWORD</b>
                               <i class='fas fa-fingerprint' style='font-size:28px;color:red'></i>
            <input type="password" name="upass" class="form-control" placeholder="Enter <?php echo $site_initial; ?> Password" 
               
               
               
               required>
         <center><blockquoe><br>
                 <p><a href="dashboard/applyonline.php">Sign up for Payhub</a></p>
              </blockquoe></center>
            </div>
        <center><button style="background-color: <?php echo $tab; ?>;" name="login" class="btn btn-success btn-sm" type="submit">
