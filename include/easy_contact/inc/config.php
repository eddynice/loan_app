...
******************************************************************/
	...
	$defaultSubject = 'Support from NFCU';
	...
	$redirectToURL = 'my.gonetonline.com ';
	...
	$smtpServer = 'mail.gonetonline.com';   
	$smtpPort = 465;                    
	$smtpUsername = 'noreply@gonetonline.com'; 
	$smtpPassword = '8*@AU$5i0zH';  
	$smtpEncryption = 'ssl';               
